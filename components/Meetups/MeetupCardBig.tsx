        ...
        <section className="flex flex-row justify-between">
          <div className="flex flex-row gap-5">
            <Image
              ...
              width={72}
              height={72}
              className="h-[48px] w-[48px] rounded-[6px] md:h-[72px] md:w-[72px]"
            />
          ...
          <div className="flex flex-col rounded-[6px] border-[1px] border-secondary5 bg-background px-4 py-[5px] text-center">
