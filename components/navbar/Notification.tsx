...
const Notification = () => {
  ...
  return (
    <>
      ...
      <article className="fixed right-[10%] flex h-[582px] w-[335px] flex-col rounded-[8px] bg-background text-secondary2 dark:bg-dark4 dark:text-background2 max-md:top-[3.5rem] md:left-[56%] md:h-[649px] md:w-[589px]">
