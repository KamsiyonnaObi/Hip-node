...
const Popup = ({ id, username }: { id: string; username: string }) => {
  ...
  return (
    <div className="mt-2">
      ...
      <div className="fixed flex aspect-square h-fit flex-col rounded-[10px] bg-background dark:bg-dark4 max-md:left-[50%] max-md:top-[3.5rem] max-md:translate-x-[-50%] md:translate-x-[-80%]">
