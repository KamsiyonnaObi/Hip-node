...
const About = ({ description }: { description: string }) => {
  return (
    <div className="flex w-[20.9375rem] flex-col gap-[.625rem] rounded-[1rem] bg-background p-[.62rem] dark:bg-dark3 sm:w-full md:w-full md:p-[1.25rem] lg:w-[13.125rem] h-[11.375rem]">
      <div>
