...
const CreateGroup = ({ title, desc, buttonText }: Props) => {
  return (
    <article className="flex w-[20.938rem] flex-col gap-2.5 rounded-[16px] bg-[#FF7C4D] bg-[url('https://i.ibb.co/ch6kNrt/Host-Meetup.png')] p-5 text-background sm:w-full">
