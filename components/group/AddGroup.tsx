        ...
        <div className="flex flex-col gap-[.62rem]">
          ...
          <div>
            <input
              ...
              onChange={handleChange}
              className="border-background2 dark:border-dark4 caption-regular text-secondary3 dark:bg-dark3 flex h-[6.875rem] w-full min-w-[18.4375rem] max-w-[52.5rem] rounded-[.5rem] border-[2px] px-[1.25rem] py-[.75rem] lg:h-[9rem] top-[0rem]"
            />
          </div>
        </div>
        <div className="flex flex-col gap-[.62rem]">
